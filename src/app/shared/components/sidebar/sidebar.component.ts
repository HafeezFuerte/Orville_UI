...
export class SidebarComponent {
  ...
  private moduleIconMap: { [key: string]: string } = {
    ...
    'Payroll': 'bx bx-money',
    'Airlines': 'bx bx-plane-alt',
    'Leave & Vacation': 'bx bx-calendar-event',
    'Normal Reports': 'bx bx-bar-chart-alt-2',
    'Performance': 'bx bx-line-chart',
    'Masters': 'bx bx-cog',
    'Recruitment': 'bx bx-user-plus',
    'Mobile Phones': 'bx bx-mobile-alt',
    'Services': 'bx bx-wrench',
    'Employee Portal': 'bx bxs-user-detail',
    'My Dashboard': 'bx bx-home-alt',
    'My Attendance': 'bx bx-calendar-check',
    'My Leave Applications': 'bx bx-file',
    'My Loan Applications': 'bx bx-wallet',
  };
  ...
  private urlMap: { [key: string]: string } = {
    ...
    'OrgChartold.aspx': '/organization-charts',
    'ViewAttendance.aspx': '/employee-timesheets',
    'NMRAttendance.aspx': '/labor-timesheets',
    'employeechanges.aspx?moduleid=1&key=1': '/relocating-employees',
    'Contacts.aspx': '/emergency-contacts',
    'EmpTermination.aspx': '/exit-interview',
    'Shifts.aspx': '/working-shifts',
    'AllowanceBilling.aspx?ModuleID=1': '/hiring-lands-buildings',
    'Reminder.aspx': '/reminder',
    'NRIDocs.aspx': '/expat-documentation',
    'Clearence.aspx': '/employee-clearance',
    'employeejobwisedes.aspx?key=1': '/job-description-responsibilities',
    'CustodianDocs.aspx': '/custodian-documents',
    'ManPowerIndent.aspx': '/manpower-request',
    'finalexit.aspx?key=1': '/end-of-service',
    'EmpWorksiteMonthWise.aspx': '/emp-transfer-history',
    'PrePaidExpensesList.aspx?ModuleID=1': '/prepaid-expenses-list',

    //Personnel
    'NewNMR.aspx': '/labor-force',
    'Directors.aspx': '/directors',
    'EmployeeList.aspx': '/employees',
    'EmpOTConfig.aspx': '/ot-employees',

    // Airlines
    'HMS_Airline.aspx': '/airlines',
    'HMS_BookingClass.aspx': '/booking-class',
    'HMS_PassengerType.aspx': '/passenger-types',
    'HMS_Relations.aspx': '/relation-types',
    'ConfigAirTicket.aspx': '/air-ticket-config',
    'EmpAirTicketAuthorisations.aspx': '/employee-airticket',

    // Payroll
    'Wages.aspx': '/payroll-masters',
    'EmpPayRoleConfigToAll.aspx': '/configurations',
    'LedgerBalances.aspx': '/ledger-acs',
    'MockSalaryCalculator.aspx': '/mock-salary-calculator',
    'EmpSalhikesV2.aspx': '/salary-revisions',
    'MonthlyWorkingDaysAndPayableDaysV4.aspx': '/payable-days',
    'MonthlyPaymentsProcessedV4.aspx': '/salary-calculations',
    'MonthlyPaymentsApprovedV4.aspx': '/approved-salaries',
    'AttendanceInAdvance.aspx': '/attendance-in-advance',
    'MonthlyPaymentsApprovedV4_NEW.aspx': '/approved-cash-payment-details',
    'MonthlyPaymentAccountPostingV4.aspx': '/salary-to-accounts',
    'SalarySignOffStatement.aspx': '/salary-sign-off',
    'reportview.aspx?reportname=/HMS/SalaryStatementAuthorisationBase': '/salary-reports',
    'PaySchedule.aspx': '/pay-schedule',
    'Pay Schedule.aspx': '/pay-schedule',
    'Pay-Schedule.aspx': '/pay-schedule',
    'Approvals.aspx': '/approvals',
    'approvals.aspx': '/approvals',
    'Approvals': '/approvals',

    // --- Financials & Accounting ---
    'EmpReimbursement.aspx': '/travel-expenses',
    'EmpAdvanceApproval.aspx?Apr=1': '/loans-advances',
    'OTPayments.aspx?key=3': '/ot-payments',
    'Gratuity.aspx?state=1': '/gratuity-provision',
    'EmpPenalties.aspx': '/employee-penalties',
    'AbsPenalities.aspx': '/absent-penalties',
    'Benefits.aspx': '/employee-benefits',
    'VacationSettlementRev4.aspx': '/vs-fs-process',
    'HRProvisions.aspx': '/hr-provisions',
    'loanadj.aspx': '/recovery-process',




    // --- Leave & Vacation ---
    'WeekOffConfigByNature.aspx': '/configuration',
    'EmpNature.aspx': '/leave-masters',
    'LeavesAvailable.aspx': '/account',
    'HRLeaveApplications.aspx': '/processing',
    'Encashment_AL.aspx': '/master-data-leaves',
    'VacationReturn.aspx': '/return-to-work',


    // --- Normal Reports ---
    'ExceRptReporting.aspx': '/employee-list',
    'EmpSalReport.aspx': '/employee-salary',
    'WageAllowance.aspx': '/salary-budget',
    'ESIReport.aspx': '/statutory-accounts',
    'EmpWorkingDetails.aspx': '/employee-transfers',
    'EmpSimBillReport.aspx': '/mobile-phone-bills',
    'EmptotDetails.aspx': '/entitlement-changes',
    'EmployeesGratuity.aspx': '/employee-gratuity',
    'DashBoard.aspx': '/dashboard',
    'reportview.aspx?reportname=/HMS/ComOfEmpPerPrj': '/employee-counts',
    'reportview.aspx?reportname=/HMS/Disciplinery': '/disciplinary-action-request',
    'reportview.aspx?reportname=/HMS/HandOutRpt': '/hand-out-rpt',
    'BIReport.aspx?key=54fd030b-1537-4ddb-b394-bec7fe326be4': '/non-moving-materials',
    'BIReport.aspx?key=2': '/bi-dashboard',
    'BIReport.aspx?key=2b44ef13-4e00-47be-8191-cdc577621e77': '/buffer-stock',
    'BIReport.aspx?key=50cd0a00-ea5f-4782-bf83-4d80fa9b6fcd': '/head-count',
    'reportview.aspx?reportname=/HMS/ExpatDocumentation': '/expat-documentation',

    // --- Performance ---
    'EmployeeWorkStatus.aspx': '/employee-work-diaries',
    'CriteriaofEmpfor_Evaluation.aspx': '/evaluation-criteria-master',
    'EmployeeEvaluation.aspx?key=1': '/employee-evaluation',



    // --- Masters ---
    'employeeorder.aspx': '/masters/reordering',
    'NewDept.aspx': '/masters/departments',
    'AddEditWorksite.aspx': '/masters/worksites',
    'Documents.aspx': '/masters/templates',
    'Designations.aspx': '/masters/job-titles',
    'FinancialYear.aspx': '/masters/financial-year',
    'Categories.aspx': '/masters/specialisations',
    'AttendanceDevice.aspx': '/masters/device',
    'EmpTypeOfMessConfiguration.aspx': '/masters/meal-types',
    'ListOfEmpMessConfiguration.aspx': '/masters/canteen-config',
    'AssessmentYear.aspx': '/masters/assessment-year',
    'employeetypes.aspx': '/masters/employee-types',
    'EMPGradeConfig.aspx': '/masters/employee-grades',
    'CustodianDocument.aspx?id=1': '/masters/custodian-doc-types',
    'jobDescriptions.aspx': '/masters/job-description',
    'ClearenceEmp.aspx': '/masters/clearance-type',
    'JobResponsibiliti.aspx': '/masters/job-responsibilities',
    'AssignWorksite.aspx?Modid=1': '/masters/assign-worksite',
    'TravelMode.aspx': '/masters/travel-mode',

    // --- Recruitment ---
    'CreatePosting.aspx': '/recruitment/positions',
    'ViewApplicantList.aspx': '/recruitment/process',
    'ViewSelectedApplicantList.aspx': '/recruitment/selections',
    'ViewOfferLetterList.aspx': '/recruitment/offers',
    'ViewAcceptedOfferList.aspx': '/recruitment/appointments',
    'CreateApplicant.aspx': '/recruitment/applicants',


    // --- Mobile Phones ---
    'SIMCardBillsList.aspx': '/bills',
    'SIMAllocationList.aspx': '/limit-config',
    'SimRegistration.aspx': '/registration',
    'SimRegistration.aspx?key=1': '/allottment',
    'SIMBillReport.aspx': '/reports',

    // --- Services ---
    'SRN.aspx': '/services/sdn',
    'SRNStatus.aspx?ID=1': '/services/process',
    'ServiceApproval.aspx': '/services/sdn-bills',
    'QuickTrans.aspx': '/services/quicktrans',


    // --- Employee Portal ---
    'ITSavings.aspx': '/my-saving-plans',
    'Feedback.aspx': '/my-feedback',
    'ChangePassWord.aspx': '/my-password',
    'EmpWork.aspx': '/my-work-diary',
    'AdvancedLeaveApplication.aspx': '/my-leave-applications',
    'PersonalPaySlip.aspx': '/my-pay-slip',
    'MyRentalDocs.aspx': '/my-rental',
    'EmpCustodianDocs.aspx': '/my-custodian-docs',
    'MyAdvances.aspx': '/my-advance-request',
    'MyLoanApplications.aspx': '/my-loan-applications',
    'EmployeeDS_Rs.aspx': '/my-job-description',
    'BlankFormatTemplate.aspx': '/blank-forms-downloads',
    'ReportsBarG.aspx': '/my-dashboard',
    'finalexit.aspx': '/my-end-of-service',
    'BussinesstripHelpOthers.aspx': '/my-attendance',

    // --- Payroll New Mappings ---
    'StatutoryComponents.aspx': '/statutory-components',
    'StatutoryBenefits.aspx': '/statutory-components',
    'PayrollPeriods.aspx': '/payroll-periods',
    'ComponentsGroup.aspx': '/components-group',
    'Components.aspx': '/components',

    // --- BI Vacation & Others ---
    'BIReport.aspx?key=c2c19b20-7e01-4b40-8a96-2df446cae8f5&grpid=b2d05362-133f-4418-a759-87f48f8fb950': '/documents-for-renewals',
    'BIReport.aspx?key=ebbbd491-b519-4886-a1c2-12e3919c2cc5&grpid=b2d05362-133f-4418-a759-87f48f8fb950': '/employees-on-vacation',
  };
