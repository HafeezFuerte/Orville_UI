...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, FormsModule, DeleteConfirmationComponent, RouterModule, ReusableModalComponent, CommonAreaPopupComponent, TranslateModule, FilterDrawerComponent, OvPaginatorComponent],
