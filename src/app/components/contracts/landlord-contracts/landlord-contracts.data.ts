export type LandlordContractStatus = 'Active' | 'Draft' | 'Completed' | 'Offered';

export interface LandlordContractRow {
  id: string;
  landlord: string;
  initials: string;
  name: string;
...
export const LANDLORD_CONTRACT_STATUS_TABS: Array<'All' | LandlordContractStatus> = [
  'All',
  'Active',
  'Draft',
  'Completed',
...
export const LANDLORD_CONTRACT_ROWS: LandlordContractRow[] = [
  {
    id: '31658',
...
export function findLandlordContract(id: string): LandlordContractRow | undefined {
  return LANDLORD_CONTRACT_ROWS.find((row) => row.id === id) ?? LANDLORD_CONTRACT_ROWS[0];
}
...
export const CONTRACT_DOCUMENTS = [
  { name: 'Landlord Agreement.pdf', meta: '2.4 MB - Updated today' },
  { name: 'Landlord Agreement.pdf', meta: '2.4 MB - Updated today' },
  { name: 'Landlord Agreement.pdf', meta: '2.4 MB - Updated today' },
  { name: 'Landlord Agreement.pdf', meta: '2.4 MB - Updated today' }
];
...
export const CONTRACT_SIGNATURES = [
  { id: '31658', status: 'Pending', name: 'John Smith', document: 'Landlord Agreement.pdf', sent: '05-06-2026', type: 'Landlord' },
  { id: '31659', status: 'Pending', name: 'Sarah Ahmed', document: 'Landlord Agreement.pdf', sent: '05-06-2026', type: 'Witness' }
];
