...
@Component({
  selector: 'app-preventive-maintenance-detail',
  standalone: true,
  ...
  styleUrl: './preventive-maintenance-detail.component.scss'
})
...
activities:any=[];
          ...
          if (Array.isArray(details) && details.length > 0) {
            const data = details[0]; 
             this.ticket ={
              ...
              technician: data.technician_user,
              responsible: data.responsible_user, 
              vendor: data.vendor,
              vendor_code: data.vendor_code,
              schedule:data.on_every + ' ' + data.time_span,
  ...
  updateticketstaus(){
    ...
    if(this.updatednotes==null || this.updatednotes==""){
     ...
     return;
      ...
      this.loadlookup(86,this.ticket.statusid,'',this.ticketId,this.updatednotes);
    }
  }
  ...
  goEdit(): void {
    this.router.navigate(['/facility/preventive-maintenance/edit',this.ticketId]);
  }
